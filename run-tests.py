...
def run_unit_tests():
    ...
    """
    tests = os.path.join('metavirommodel', 'tests')
...
def doctest_rst_and_public_interface():
    ...
    metavirommodel_submodules = [
        ...
        'metavirommodel._preypredmodels',
        'metavirommodel.inference',
        ]
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Run unit test for metavirommodel',
        epilog='To run individual unit tests, use e.g.'
               ' $ python3 metavirommodel/tests/test_dummy.py',
    )
    # Unit tests
    parser.add_argument(
        '--unit',
