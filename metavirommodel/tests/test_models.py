...
class TestLogisticGrowthMetaviromodel(unittest.TestCase):
    """
    Test the 'LogisticGrowthMetaviromodel' class.
    """
    def test__init__(self):
        ...
        self.assertEqual(model._carry_cap(5), 20)

        model = mm.LogisticGrowthMetaviromodel(carry_cap)
        self.assertEqual(model._carry_cap(5), 20)
