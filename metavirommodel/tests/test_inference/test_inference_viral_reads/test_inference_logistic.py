...
class TestLogisticGrowthMVRVirRead(unittest.TestCase):
    """
    Test the 'LogisticGrowthMVRVirRead' class.
    """
    def test__call__(self):
        ...
        log_lik = mvri.LogisticGrowthMVRVirReadLogLik(
...
#
# Test LogisticGrowthMVRVirRead Inference and Optimisation Class
#

class TestLogisticGrowthMVRVirReadInfer(unittest.TestCase):
    """
    Test the 'LogisticGrowthMVRVirReadInfer' class.
    """
    def test__init__(self):
        ...
        inference = mvri.LogisticGrowthMVRVirReadInfer(model, generation_times)

        self.assertIsInstance(inference._model,
                              mvr.LogisticGrowthMetaviromodel)

        with self.assertRaises(TypeError):
            mvr.inference.LogisticGrowthMVRVirReadInfer(0)
    ...
    def test_optimisation_problem_setup(self):
        ...
        # Set up MVRVirRead Inference class
        optimisation = mvri.LogisticGrowthMVRVirReadInfer(
