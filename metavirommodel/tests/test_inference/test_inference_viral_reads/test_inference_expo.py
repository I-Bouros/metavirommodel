...
#
# Toy ExponentialGrowthMetaviromodel Model Class
#

class TestExponentialGrowthMetaviromodel(mvr.ExponentialGrowthMetaviromodel):
    """
    Toy ExponentialGrowthMetaviromodel model class used for testing.
    """
    def __init__(self):
        # Instantiate model
        super(TestExponentialGrowthMetaviromodel, self).__init__()

        self.algorithm = mvr.ExponentialGrowthMetaviromodel()
...
class TestViralReadData(object):
    ...
    def __init__(self, model, viral_model):
        # Run ExponentialGrowthMetaviromodel model
        self.model = model
...
class TestExponentialGrowthMVRVirRead(unittest.TestCase):
    """
    Test the 'ExponentialGrowthMVRVirRead' class.
    """
    def test__call__(self):
        ...
        model = TestExponentialGrowthMetaviromodel()
        ...
        log_lik = mvri.ExponentialGrowthMVRVirReadLogLik(
...
#
# Test ExponentialMVRVirRead Inference and Optimisation Class
#

class TestExponentialGrowthMVRVirReadInfer(unittest.TestCase):
    """
    Test the 'ExponentialGrowthMVRVirReadInfer' class.
    """
    def test__init__(self):
        ...
        inference = mvri.ExponentialGrowthMVRVirReadInfer(
            model, generation_times)

        self.assertIsInstance(inference._model,
                              mvr.ExponentialGrowthMetaviromodel)

        with self.assertRaises(TypeError):
            mvr.inference.ExponentialGrowthMVRVirReadInfer(0)
    ...
    def test_optimisation_problem_setup(self):
        ...
        # Set up MVRVirRead Inference class
        optimisation = mvri.ExponentialGrowthMVRVirReadInfer(
            model, generation_times)
