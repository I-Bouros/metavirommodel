...
class TestExponentialGrowthMVRCtValLogLik(unittest.TestCase):
    """
    Test the 'ExponentialGrowthMVRCtValLogLik' class.
    """
    def test__call__(self):
        ...
        log_lik = mvri.ExponentialGrowthMVRCtValLogLik(
...
class TestPHELogPrior(unittest.TestCase):
    ...
    def test__call__(self):
        ...
        log_prior = mvri.ExponentialMVRCtValLogPrior(model)
...
class TestExponentialGrowthMVRCtValInfer(unittest.TestCase):
    """
    Test the 'ExponentialGrowthMVRCtValInfer' class.
    """
    def test__init__(self):
        ...
        inference = mvri.ExponentialGrowthMVRCtValInfer(
        ...
        with self.assertRaises(TypeError):
            mvr.inference.ExponentialGrowthMVRCtValInfer(0)
    ...
    def test_optimisation_problem_setup(self):
        ...
        # Set up MVRCtVal Inference class
        optimisation = mvri.ExponentialGrowthMVRCtValInfer(
            model, generation_times)
