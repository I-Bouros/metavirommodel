...
#
# LogisticGrowthMVRCtValInfer Class
#

class LogisticGrowthMVRCtValLogLik(mvri.MVRCtValLogLik):
    """LogisticGrowthMVRCtValLogLik Class:
...
class LogisticMVRCtValLogPrior(pints.LogPrior):
    """LogisticMVRCtValLogPrior Class:
    ...
    def __init__(self, model):
        super(LogisticMVRCtValLogPrior, self).__init__()
    ...
    def __call__(self, x):
        ...
        return uniform.logpdf(x[0], 1.05, 5)
...
class LogisticGrowthMVRCtValInfer(mvri.MVRCtValInfer):
    """LogisticGrowthMVRCtValInfer Class:
    ...
    def __init__(self, model, generation_times):
        super(LogisticGrowthMVRCtValInfer, self).__init__(
    ...
    def return_loglikelihood(self, x):
        ...
        """
        loglikelihood = LogisticGrowthMVRCtValLogLik(
    ...
    def _create_posterior(self):
        ...
        """
        # Create a likelihood
        self.loglikelihood = LogisticGrowthMVRCtValLogLik(
            self._model, self._ct_values, self._ct_parameters,
            self._generation_times)
