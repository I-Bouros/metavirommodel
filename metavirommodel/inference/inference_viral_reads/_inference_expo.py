...
#
# ExponentialGrowthMVRVirReadLogLik Class
#

class ExponentialGrowthMVRVirReadLogLik(mvri.MVRVirReadLogLik):
    """ExponentialGrowthMVRVirReadLogLik Class:
...
#
# ExponentialGrowthMVRVirReadInfer Class
#

class ExponentialGrowthMVRVirReadInfer(mvri.MVRVirReadInfer):
    """ExponentialGrowthMVRVirReadInfer Class:
    ...
    def __init__(self, model, generation_times):
        super(ExponentialGrowthMVRVirReadInfer, self).__init__(
    ...
    def return_loglikelihood(self, x):
        ...
        """
        loglikelihood = ExponentialGrowthMVRVirReadLogLik(
    ...
    def _create_posterior(self):
        ...
        """
        # Create a likelihood
        self.loglikelihood = ExponentialGrowthMVRVirReadLogLik(
            self._model, self._viral_read_counts, self._vl_parameters,
            self._generation_times)

        # Create a prior
        log_prior = mvri.ExponentialMVRCtValLogPrior(self._model)
