...
def main():
    """
    Processes the hourly oberved precipitation levels to determine the total
    daily levels of rainfall during the specified dates.

    Returns
    -------
    csv
        Processed file for the daily total precipitation levels.
    ...
    # Transform recorded precipitation levels to csv file
